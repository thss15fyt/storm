# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-05 07:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='remittance_items', to='eshop.Goods')),
        ...
        migrations.AddField(
            model_name='comment',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', related_query_name='comment', to='eshop.RemittanceItem'),
        ),
    ]
