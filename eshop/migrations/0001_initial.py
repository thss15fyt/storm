    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=20)),
                ('item', models.ManyToManyField(to='eshop.Goods')),
            ],
        ),
        migrations.CreateModel(
            name='Remittance',
        ...
        migrations.AddField(
            model_name='goods',
            name='RemittanceItem',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='remittanceitem_goods', related_query_name='remittanceitem_goods', to='eshop.RemittanceItem'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goods_type',
        ...
        migrations.AddField(
            model_name='goods',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goods', to='eshop.Shop'),
        ),
        migrations.AddField(
            model_name='goods',
            name='shoppingCartItem',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='shoppingitem_goods', related_query_name='shoppingitem_goods', to='eshop.ShoppingCartItem'),
        ),
        migrations.AddField(
            model_name='comment',
            name='author',
